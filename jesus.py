...
def genPlainColor(r, g, b):
    ...
    plain_color = Image.new("RGBA", (2000, 2000), color=(r, g, b, 255))
...
def genTemplateColor(r, g, b):
    ...
    # Create a new image with the given color.
    base_image = Image.new("RGBA", image_size, color=(r, g, b, 255))
